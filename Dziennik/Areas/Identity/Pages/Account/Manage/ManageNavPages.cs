...
public static class ManageNavPages
{
	...
	public static string RequestRole => "RequestRole";
	...
	public static string RequestRoleNavClass(ViewContext viewContext)
	{
		return PageNavClass(viewContext, RequestRole);
	}
