...
namespace Dziennik.Migrations
{
    ...
    [Migration("20240118013614_Add tasks and marks")]
    partial class Addtasksandmarks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dziennik.Models.PresenceLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Dziennik.Models.PresenceRecord", b =>
                {
                    b.Property<Guid>("StudentId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("PresenceLogId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("Presence")
                        .HasColumnType("int");

                    b.HasKey("StudentId", "PresenceLogId");

                    b.HasIndex("PresenceLogId");
            ...
            modelBuilder.Entity("Dziennik.Models.Scoring.ClassTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Dziennik.Models.Scoring.Mark", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Dziennik.Models.Course", b =>
                {
                    ...
                    b.HasOne("Dziennik.Models.DidacticCycle", null)
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("Dziennik.Models.PresenceRecord", b =>
                {
                    b.HasOne("Dziennik.Models.PresenceLog", "PresenceLog")
                        .WithMany("Students")
                        .HasForeignKey("PresenceLogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Dziennik.Models.Roles.Student", "Student")
                        .WithMany("PresenceRecords")
                        .HasForeignKey("StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PresenceLog");
            ...
            modelBuilder.Entity("Dziennik.Models.Scheduling.Event", b =>
                {
                    b.HasOne("Dziennik.Models.Course", "Course")
                        .WithMany("Lessons")
                    ...
                    b.HasOne("Dziennik.Models.PresenceLog", "Presence")
                        .WithMany()
                        .HasForeignKey("PresenceId");

                    b.HasOne("Dziennik.Models.Scheduling.RecurringEvent", "Template")
                        .WithMany("Events")
            ...
            modelBuilder.Entity("Dziennik.Models.Scoring.ClassTask", b =>
                {
                    ...
                    b.HasOne("Dziennik.Models.Roles.Teacher", "TaskMaster")
                        .WithMany("Tasks")
            ...
            modelBuilder.Entity("Dziennik.Models.Scoring.Mark", b =>
                {
                    b.HasOne("Dziennik.Models.Roles.Student", "Reciever")
                        .WithMany("Marks")
                        .HasForeignKey("RecieverId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Dziennik.Models.Scoring.ClassTask", "ClassTask")
                        .WithMany("Marks")
