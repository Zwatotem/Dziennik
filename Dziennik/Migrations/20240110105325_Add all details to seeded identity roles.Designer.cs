...
namespace Dziennik.Migrations
{
    ...
    [Migration("20240110105325_Add all details to seeded identity roles")]
    partial class Addalldetailstoseededidentityroles
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole<System.Guid>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2a322a57-1393-4865-b376-7202f048ccfb"),
                            ConcurrencyStamp = "cf4a8727-82b3-4a5d-8488-30d0979d2b67",
                            Name = "Administrator",
                            NormalizedName = "ADMINISTRATOR"
                        },
                        new
                        {
                            Id = new Guid("05b3d8ed-2358-476f-bd86-c15870341d9a"),
                            ConcurrencyStamp = "68f80428-3734-4a2f-b037-a5ca5b8ca748",
                            Name = "Teacher",
                            NormalizedName = "TEACHER"
                        },
                        new
                        {
                            Id = new Guid("5ea6d9a6-9f7d-4502-bf16-8ac4780012f8"),
                            ConcurrencyStamp = "29ceb763-2a2b-4b92-9182-23c28202c467",
                            Name = "Student",
                            NormalizedName = "STUDENT"
                        },
                        new
                        {
                            Id = new Guid("2e23d065-38bf-4a7a-a29e-7672673683fa"),
                            ConcurrencyStamp = "1afc9db3-1652-4491-b73b-4e6d159f0bb3",
                            Name = "Parent",
            ...
            modelBuilder.Entity("Dziennik.Models.Roles.Teacher", b =>
                {
                    b.HasOne("Dziennik.Models.CourseProgram", null)
                        .WithMany("DedicatedTeachers")
                        .HasForeignKey("CourseProgramId");
                });

            modelBuilder.Entity("Dziennik.Models.CourseProgram", b =>
                {
                    b.Navigation("DedicatedTeachers");
                });
